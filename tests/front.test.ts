...
const managers: FrontManagerInput[] = [{ id: 'mgr1', name: 'Іван', grade: 'MIDDLE' }];
...
describe('computeFront', () => {
  it('факт = план → 100% по кожній метриці і % KPI = 100', () => {
    ...
    const [r] = computeFront(metrics, managers, data, 'LINEAR', { baseBonus: 1000 });
  ...
  it('зовсім без даних → % KPI = 0, бонус = 0', () => {
    const [r] = computeFront(metrics, managers, {}, 'MATRIX', { baseBonus: 1000 });
